...
class References extends Component {
  ...
  getDeviantData() {
    const url = 'https://www.deviantart.com/api/v1/oauth2/browse/popular?category_path=designs/web&q=';
    ...
    return axios
      ...
      .then(token => {
        return axios.get(`${cors}${url}${searchTerm}${options}access_token=${token.access_token}`);
      })
  ...
  render() {
    ...
    return (
      <div className="wrapper" style={style.wrapper}>
        ...
        <div className="references-wrap" id="reference-wrapper" style={style.wrapper.elementsWrap}>
