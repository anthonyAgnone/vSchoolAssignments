...
export default class DeviantRoute extends Component {
	render() {
		...
		const projectElements = this.props.data.map(project => (
			<div className="project-wrapper" key={project.deviationid} id={project.deviationid}>
				<a
				...
				>
					<img style={style.wrapper.img} src={project.preview.src} alt="" />
				</a>
			</div>
		));
		return (
			<div className="deviant-wrapper" style={style.wrapper}>
				<h1 style={style.wrapper.title}>Deviant Art Example Projects</h1>
